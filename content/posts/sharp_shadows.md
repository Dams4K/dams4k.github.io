...
Ce qu'on peut faire cependant pour essayer de pallier ça, c'est de diminuer la distance max des ombres. De cette manière, on va diminuer la surface que prendra le dernier split, et on pourra ainsi voir les ombres jusqu'au bout. Cependant la qualité sera vraiment mauvaise car on a toujours une trop grande surface pour une shadow map trop petite. Le vrai problème ici, c'est d'avoir mis des valeurs absurdes pour les splits.
...
![LightmapGI with low distance max](/images/sharp_shadows/lightmap_shadow.png)
...
Quelque chose qui peut surprendre quand on passe à la vue orthogonale, c'est qu'on ne voit aucune ombre. 

## Conclusion

Putain avoir des ombres nettes c'est CHIANT ! Et si Unreal Engine arrive à avoir une ombre de bonne qualité facilement, c'est car ils utilisent des Virtual Shadow Maps, je ne me suis pas renseigné pour connaître les détails techniques, mais manifestement c'est mieux. Enfin c'est mieux, comme toujours c'est mieux dans certains cas.